...
import type { StickyNoteNodeData, StickyNoteColor } from '../../types'
    ...
    <>
      ...
      >
        ...
        <InlineEditableLabel
          ...
          className={cn('block max-w-[140px] whitespace-pre-line break-words text-sm', data.bold && 'font-bold', data.italic && 'italic')}
          inputClassName={cn('w-full text-sm', data.bold && 'font-bold', data.italic && 'italic')}
        />
      </div>
    </>
  )
