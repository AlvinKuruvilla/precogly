...
- **Missing required fields (title, trust_zone on component):** Reject entity with warning, continue import (partial import). _Or:_ reject entire file — TBD during implementation.
